...
- `SCAN_MODE_ARGS_MAP` (default: `bw:--mode Gray --contrast 50 --highlight 80,color:--mode Color`)
  - The default black-and-white profile targets AirScan devices that expose only
    `Gray` and `Color`. Increased contrast and a lower highlight reduce paper
    texture and light background shading in text scans.
